...
is currently (2023) the Teensy 4.1 (a pity it doesn't have 
the nexopixel driver built in).
...
The library is split in a core which is always loaded into RAM, 
and a number of optional parts, which are loaded only when used.
...
Currently only upo to 4 Mb of the RAM chip seems to be used.
