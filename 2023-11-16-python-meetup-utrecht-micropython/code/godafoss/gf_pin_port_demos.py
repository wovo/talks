...
def show(
    pin: [ int, pin_in_out, pin_in, pin_oc ],
    interval: int = 500_000,
    iterations = None
) -> None:
    """
    show pin state on the pin
    
    Print the pin state (True or False) each interval microseconds.
    """
